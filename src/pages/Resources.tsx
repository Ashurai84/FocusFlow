...
export function Resources() {
  ...
  return (
    <div className="h-[600px] bg-gradient-to-br from-orange-400 via-red-500 to-pink-600 dark:from-gray-900 dark:via-orange-900 dark:to-red-900 overflow-y-auto">

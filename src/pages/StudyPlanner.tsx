...
export function StudyPlanner() {
  ...
  return (
    <div className="h-[600px] bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 dark:from-gray-900 dark:via-green-900 dark:to-blue-900 overflow-y-auto">

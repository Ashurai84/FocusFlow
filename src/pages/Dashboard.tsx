...
import { Sparkles, Target, Clock, Music, TrendingUp } from 'lucide-react';
...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 dark:from-gray-900 dark:via-purple-900 dark:to-indigo-900 p-4 pb-24">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <QuoteCard userType={user?.field.toLowerCase() || 'general'} />
          </motion.div>
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-white font-semibold text-lg">Study Music</h3>
          </div>
          <SpotifyPlayer />
        </motion.div>
      </div>

...
export function Community() {
  ...
  return (
    <div className="h-[600px] bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-600 dark:from-gray-900 dark:via-purple-900 dark:to-indigo-900 overflow-y-auto">
